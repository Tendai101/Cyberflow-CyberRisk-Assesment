...
class YourRiskAssessmentClass:
    ...
    # Use if statements to assign scores based on the network architecture
     if digital_asset == "Non-Critical information":
        ...
        paragraph_d = "If an organization possesses non-critical information, such as general marketing materials or publicly available data, the level of risk posed by cyber attacks may be relatively lower compared to sensitive or proprietary information. However, it is essential to recognize that even seemingly insignificant data can still be valuable to cybercriminals for various purposes, including phishing scams, identity theft, or reconnaissance for future attacks. While the potential impact of a successful cyber attack on non-critical information may be less severe in terms of financial or reputational damage, it can still result in disruptions to business operations, loss of customer trust, and regulatory compliance issues. Therefore, even when dealing with non-critical information, organizations should implement appropriate cybersecurity measures to safeguard against potential threats and ensure the integrity, availability, and confidentiality of their data."
     elif digital_asset == "Customer Lists":
        probability_score_d = 2
        paragraph_d = "If a company possesses customer lists, the level of risk of cyber attacks is heightened due to the sensitive nature of the information contained within these lists. Customer lists typically include personally identifiable information (PII) such as names, contact details, and sometimes financial data. As such, they are highly sought after by cybercriminals for various malicious purposes, including identity theft, phishing scams, and targeted attacks. A breach of customer lists can have severe consequences for both the affected individuals and the company, leading to financial losses, reputational damage, and legal repercussions. Therefore, safeguarding customer lists should be a top priority for organizations, necessitating robust security measures such as encryption, access controls, regular security audits, and employee training to mitigate the risk of cyber attacks and protect the privacy of customers."
     elif digital_asset == "User Credentials" or digital_asset == "Employee Records":
        probability_score_d = 3
        if digital_asset == "User Credentials":
           paragraph_d = "The level of risk of cyber attacks significantly increases if an attacker gains access to user credentials. User credentials, such as usernames and passwords, are often the primary means of authentication for accessing various systems, applications, and resources within an organization's network. If compromised, these credentials can provide attackers with unauthorized access to sensitive data, systems, and accounts, potentially leading to data breaches, financial losses, and reputational damage. With access to user credentials, attackers can impersonate legitimate users, bypass security controls, and escalate their privileges within the network, making it easier for them to carry out malicious activities undetected. Therefore, safeguarding user credentials through robust security measures such as multi-factor authentication, password policies, and user education is crucial for mitigating the risk of cyber attacks and protecting organizational assets."
        else:
           paragraph_d = "The level of risk of cyber attacks associated with employee records can be significant, given the sensitive nature of the information contained within such records. Employee records typically include personal data such as names, addresses, Social Security numbers, and potentially sensitive employment-related information. Cyber attackers may target employee records for various reasons, including identity theft, financial fraud, or corporate espionage. A successful breach of employee records can have severe consequences, including financial losses, reputational damage, and legal liabilities for the organization. Moreover, compromised employee records can be used to launch further attacks, such as spear-phishing campaigns targeting employees or credential stuffing attacks against other systems and applications. Therefore, organizations must prioritize the protection of employee records through robust security measures, including encryption, access controls, regular security audits, and employee training on cybersecurity best practices."
